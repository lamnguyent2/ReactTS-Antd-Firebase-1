...
export interface INumberLevelManagementWaitingProps { }

const NumberLevelManagementWaitingComponent: React.FC<INumberLevelManagementWaitingProps> = () => {
            ...
            if (data !== null) {
                Object.values(data).map((todo: any) => (
                    todo.NumberLevels.map((dd:any) =>(
                        dd.status.classstatus === "dang-cho" ? (
    ...
    return (
        <div className='NumberLevelMananementWaiting-Component'>
            <Layout>
                <LeftMenu KeysMenu="4" />
                <Layout>
...
export default NumberLevelManagementWaitingComponent;