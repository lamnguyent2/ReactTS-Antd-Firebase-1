...
export interface INumberLevelManagementSkippedProps { }

const NumberLevelManagementSkippedComponent: React.FC<INumberLevelManagementSkippedProps> = () => {
    ...
    return (
        <div className='NumberLevelMananementSkipped-Component'>
            <Layout>
                <LeftMenu KeysMenu="4" />
                <Layout>
...
export default NumberLevelManagementSkippedComponent;