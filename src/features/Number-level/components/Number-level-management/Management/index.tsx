...
export interface INumberLevelMananementProps { }

const NumberLevelMananementComponent: React.FC<INumberLevelMananementProps> = () => {
    ...
    return (
        <div className='NumberLevelMananement-Component'>
            <Layout>
                <LeftMenu KeysMenu="4" />
                <Layout>
                    <Content style={{ margin: '24px 16px 0' }}>
                        ...
                        <div className="number-details" style={{ height: "490px !important" }}>
                            <Table rowClassName={(record, index) => index % 2 === 0 ? 'table-row-light' : 'table-row-dark'} columns={columns} dataSource={dataNumber[0]?.NumberLevels} pagination={{ pageSize: 9, prevIcon: <CaretLeftOutlined />, nextIcon: <CaretRightOutlined /> }} bordered />
                        </div>
                    </Content>
                </Layout>
            </Layout>
...
export default NumberLevelMananementComponent;