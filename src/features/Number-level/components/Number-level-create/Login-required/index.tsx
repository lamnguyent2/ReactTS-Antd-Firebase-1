...
export interface INumberLevelCreateLoginRequiredProps { }

const NumberLevelCreateLoginRequiredComponent: React.FC<INumberLevelCreateLoginRequiredProps> = () => {
    ...
    return (
        <div className='NumberLevelCreateLoginRequired-Component'>
            <Layout>
                <LeftMenu KeysMenu="4" />
                <Layout>
            ...
            <Modal title="Basic Modal" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
                <div className='Pop-Up'>
                    <div className="information">
                        ...
                        <h1>{sttauto}</h1>
                        <p>DV: {details.service} <span>(tại quầy số 1)</span></p>
                    </div>
...
export default NumberLevelCreateLoginRequiredComponent;